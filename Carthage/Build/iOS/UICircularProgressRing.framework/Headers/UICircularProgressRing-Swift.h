...
/// Two concrete implementations are provided, refer to <code>UICircularTimerRingFormatter</code>
/// and <code>UICircularProgressRingFormatter</code>
SWIFT_CLASS("_TtC22UICircularProgressRing28UICircularRingValueFormatter")
@interface UICircularRingValueFormatter : NSFormatter
/// returns result of <code>string(forValue:)</code>
...
SWIFT_CLASS("_TtC22UICircularProgressRing31UICircularProgressRingFormatter")
@interface UICircularProgressRingFormatter : UICircularRingValueFormatter
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, strong) UICircularRingValueFormatter * _Nullable valueFormatter;
...
SWIFT_CLASS("_TtC22UICircularProgressRing28UICircularTimerRingFormatter")
@interface UICircularTimerRingFormatter : UICircularRingValueFormatter
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
